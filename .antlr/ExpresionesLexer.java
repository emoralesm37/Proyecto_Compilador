...
public class ExpresionesLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IF", "ELSE", "WHILE", "FOR", "RETURN", "PRINT", "PROGRAM", "VOID", "INT_T", 
			"FLOAT_T", "BOOL_T", "STRING_T", "BOOL_LIT", "SUMA", "RESTA", "MULTIP", 
			"DIV", "MOD", "EQ", "NOEQ", "MENIQ", "MAYIQ", "MENOR", "MAYOR", "AND", 
			"OR", "NOT", "ASIGNA", "PARENA", "PARENC", "LLAVEA", "LLAVEC", "CORCHETA", 
			"CORCHETC", "PCOMA", "COMMA", "FLOAT_LIT", "NUM", "STRING_LIT", "ID", 
